...
module.exports = function (RED) {
  function execScriptNode(config) {
    ...
    node.on('input', function (msg) {
      ...
      var url = config.netpalm_server.transport+"://"+config.netpalm_server.ip+":"+config.netpalm_server.port.toString()+"/script";
      request.post(url, {
        body: payl,
        headers: headers
      }, (error, res, body) => {
  ...
  RED.nodes.registerType("execscript", execScriptNode);
}